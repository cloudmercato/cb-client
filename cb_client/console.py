...
MtrArgumentParser = subparser.add_parser('mtr', help='tracepath help')
MtrArgumentParser.add_argument('-de', '--destination-id', help='')
MtrArgumentParser.add_argument('-De', '--destination-type', help='')
MtrArgumentParser.add_argument('--datacenter', required=False, help='')
MtrArgumentParser.add_argument('--timeout', required=True, help='')
MtrArgumentParser.add_argument('--interval', required=True, help='')
MtrArgumentParser.add_argument('--gracetime', required=True, help='')
MtrArgumentParser.add_argument('--first-ttl', required=True, help='')
MtrArgumentParser.add_argument('--max-ttl', required=True, help='')
MtrArgumentParser.add_argument('--max-unknown', required=True, help='')
MtrArgumentParser.add_argument('--transport', required=True, help='')
MtrArgumentParser.add_argument('--ip-version', required=True, help='')
MtrArgumentParser.add_argument('--port', required=True, help='')
MtrArgumentParser.add_argument('--bit-pattern', required=True, help='')
MtrArgumentParser.add_argument('--mpls', action="store_true", help='')
MtrArgumentParser.add_argument('--mark', required=True, help='')
...
OllamaBenchmarkSpeedParser.add_argument('--ollama_num_parallel', help='')
